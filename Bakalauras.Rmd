...
ggsave(
  paste0(Vizualizaciju_Aplankas, "\\KMSA_square_CSS_1.png"),
  plot = KMSA_square_CSS_1,
  width = 17,
  height = 7,
  units = c("in")
)
...
ggsave(
  paste0(Vizualizaciju_Aplankas, "\\KMSA_square_CSS_2.png"),
  plot = KMSA_square_CSS_2,
  width = 17,
  height = 8,
  units = c("in")
)
